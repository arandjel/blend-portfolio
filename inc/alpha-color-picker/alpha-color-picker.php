...
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		$default_script_location = get_stylesheet_directory_uri() . '/inc/alpha-color-picker/alpha-color-picker.js';
		...
		$default_styles_location = get_stylesheet_directory_uri() . '/inc/alpha-color-picker/alpha-color-picker.css';
